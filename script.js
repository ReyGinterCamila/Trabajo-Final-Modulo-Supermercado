const productos = [
  { nombre: 'Bifes en Oferta', precio: 700, stock: 10 },
  { nombre: 'Supremas', precio: 300, stock: 5 },
  { nombre: 'Filet de merluza', precio: 200, stock: 8 },
  { nombre: 'Tomate Mar del Plata kilo', precio: 400, stock: 12 },
  { nombre: 'Lechuga mantecosa x kilo', precio: 600, stock: 3 },
  { nombre: 'Zanahoria x kilo', precio: 250, stock: 7 }
];
